...
const notes = [
  ...
  { date: "2026.05.09", category: "note", title: "Traffic Path of Proxy Networking", desc: "梳理客户端、DNS、隧道、端口与远程服务器之间的流量路径。", path: "posts/Traffic_Path_of_Proxy_Networking.md" },
  { date: "2026.04.30", category: "note", title: "PyTorch High-Frequency Core Operators", desc: "张量形状、线性代数、掩码与 Softmax 的高频操作地图。", path: "posts/PyTorch_high-frequency_core_operators.md" },
  { date: "2026.04.16", category: "note", title: "Linux Basic Usage", desc: "面向日常研发环境的 Linux 命令行基础。", path: "posts/Linux_Basic_Usage.md" },
  ...
  { date: "2025.09.20", category: "note", title: "Async/Await in Python", desc: "用清晰的心智模型理解协程与异步程序。", path: "posts/async & await in python.md" },
  ...
  { date: "2025.06.15", category: "note", title: "Random Seed 42", desc: "可复现实验为什么仍然需要完整的上下文。", path: "posts/Random_seed_42.md" },
];
